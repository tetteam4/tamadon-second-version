    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Designer', 'Designer'), ('Reception', 'Reception'), ('SuperDesigner', 'SuperDesigner'), ('Admin', 'Admin'), ('Printer', 'Printer'), ('Delivered', 'Delivered'), ('Digital', 'Digital'), ('Bill', 'Bill'), ('Chaspak', 'Chaspak'), ('Shop_role', 'Shop role'), ('Laser', 'Laser'), ('Complete', 'Complete')], default='Designer', max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
